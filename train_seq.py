...
import lidiff.datasets.datasets_seq as dataset_seq
import lidiff.models.models_seq as models
# import lidiff.models.models_transformer as models
...
@click.option('--config',
              ...
              default='/media/zzy/Data/PC_Denoise/code/hdd/SonarDiff/lidiff/experiments/2025_06_27__00_11_58/lightning_logs/version_0/hparams.yaml'
              )
@click.option('--weights',
              '-w',
              type=str,
              help='path to pretrained weights (.ckpt). Use this flag if you just want to load the weights from the checkpoint file without resuming training.',
              default="/media/zzy/Data/PC_Denoise/code/hdd/SonarDiff/lidiff/experiments/2025_06_27__00_11_58/lightning_logs/version_0/checkpoints/2025_06_27__00_11_58_epoch=99.ckpt"
              )
...
@click.option('--test', '-t', default=True, help='test mode')
def main(config, weights, checkpoint, test):
    set_deterministic()

    cfg = yaml.safe_load(open(config))
    cfg['experiment']['id'] = time.strftime('%Y_%m_%d__%H_%M_%S', time.localtime())
    ...
    if weights is None:
        ...
        if test:
            ...
            ckpt_cfg['train']['uncond_min_w'] = cfg['train']['uncond_w']
    ...
    data = dataset_seq.dataloaders[cfg['data']['dataloader']](cfg)
